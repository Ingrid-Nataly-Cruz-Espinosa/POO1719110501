...
class SIENTIFICA(calculadora):
  ...
  def __init__(self):
    print("CIENTIFICA")
  def encender(self):
    print("Preciona el boton ON ")
  def apagar(self):
    print("Apagado automatico o preciona el boton OFF")
  def escolar(self):
    print("Soy ideal para ir contigo a la escuela")
  def trabajo(self):
    print("Soy ideal para tu trbajo tambien")
